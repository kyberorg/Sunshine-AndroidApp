...
public class ForecastWeatherUpdater extends WeatherUpdater {

    private static final String TAG = ForecastWeatherUpdater.class.getSimpleName();

    @Override
    public void performUpdate(@NonNull Context context){
        this.context = context;

        String locationQuery = Utility.getPreferredLocation(this.context);
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APP_ID_PARAM, "1130cdb8cd6bf24a286801b4e225dda6")
                    .build();
     ...
     */
    @Override
    protected void getWeatherDataFromJson(String forecastJsonStr,
    ...
    protected long addLocation(String locationSetting, String cityName, double lat, double lon) {
        long locationId;
        Cursor locationCursor = this.context.getContentResolver().query(
        ...
        if(locationCursor.moveToFirst()) {
            ...
            Uri insertedUri = this.context.getContentResolver().insert(
                    WeatherContract.LocationEntry.CONTENT_URI,
                    locationValues
            );
