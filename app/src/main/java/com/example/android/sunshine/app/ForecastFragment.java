...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            //No params - nothing to look for
            if(params.length == 0) {
                Log.d(TAG, "Got 0 params. Exiting...");
                return EMPTY_ARRAY;
            }
            ...
            String units = "metric";
            int numberOfDays = 7;
            String applicationId = "1130cdb8cd6bf24a286801b4e225dda6";
            ...
            try {
                ...
                Uri uri = new Uri.Builder()
                        ...
                        .appendQueryParameter("appId", applicationId)
                        .build();
                Log.d(TAG, "Connecting to: " + uri.toString());

                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&mode=json&units=metric&cnt=7&appId=1130cdb8cd6bf24a286801b4e225dda6");
            ...
            try {
                ...
                Log.e(TAG, "Problem parsing Weather JSON", e);
                return EMPTY_ARRAY;
            }
        }
